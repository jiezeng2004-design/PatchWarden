...
import type { ToolDef } from "../definitions/toolDefs.js";
...
const STATIC_TOOL_META: Record<string, StaticToolMeta> = {
  ...
  create_file: {
    title: "Create File",
    summary: "Create a guarded UTF-8 text file in a Direct session",
    profiles: ["full", "chatgpt_direct"],
    modes: ["direct"],
    tags: ["file", "create", "write", "direct"],
    aliases: ["new_file"],
    risk: "workspace_write",
    requiresConfirmation: false,
    relatedTools: ["mkdir", "apply_patch", "finalize_direct_session"],
  },
  mkdir: {
    title: "Create Directory",
    summary: "Create one guarded directory level in a Direct session",
    profiles: ["full", "chatgpt_direct"],
    modes: ["direct"],
    tags: ["directory", "mkdir", "create", "direct"],
    aliases: ["create_directory"],
    risk: "workspace_write",
    requiresConfirmation: false,
    relatedTools: ["create_file", "move_file"],
  },
  move_file: {
    title: "Move File",
    summary: "Move a hash-validated text file without overwriting its target",
    profiles: ["full", "chatgpt_direct"],
    modes: ["direct"],
    tags: ["file", "move", "rename", "direct"],
    aliases: ["rename_file"],
    risk: "workspace_write",
    requiresConfirmation: false,
    relatedTools: ["mkdir", "finalize_direct_session"],
  },
  delete_file: {
    title: "Delete File",
    summary: "Delete one hash-validated text file with explicit confirmation",
    profiles: ["full", "chatgpt_direct"],
    modes: ["direct"],
    tags: ["file", "delete", "remove", "direct"],
    aliases: ["remove_file"],
    risk: "workspace_write",
    requiresConfirmation: true,
    relatedTools: ["read_workspace_file", "finalize_direct_session"],
  },
  create_direct_session: {
    ...
    risk: "workspace_write",
    requiresConfirmation: false,
    relatedTools: ["request_direct_review", "apply_patch", "search_workspace", "finalize_direct_session"],
  },
  request_direct_review: {
    title: "Request Direct Review",
    summary: "Review one exact Direct operation before it is executed",
    profiles: ["full", "chatgpt_direct"],
    modes: ["direct", "audit"],
    tags: ["direct", "review", "approval", "policy", "safety"],
    aliases: ["direct_review", "review_direct_operation"],
    risk: "readonly",
    requiresConfirmation: false,
    relatedTools: ["create_direct_session", "apply_patch", "run_verification"],
  },
