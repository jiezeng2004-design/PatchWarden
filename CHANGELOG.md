...
- Preserve the independently verified v1.6.7 GitHub Release, npm, tag, and
  uploaded asset evidence while preparing the v1.7.0 source release.
- Add a release metadata drift check for package versions and Core/Direct tool
  counts, normalizing Windows CRLF documentation before exact assertions.
